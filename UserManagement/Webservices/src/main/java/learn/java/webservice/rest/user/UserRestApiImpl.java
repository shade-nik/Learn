...
public class UserRestApiImpl implements UserRestApi {
	...
	@Override
	@RequestMapping(produces = { MediaType.APPLICATION_JSON_VALUE }, value = "/{username}", method = {
			RequestMethod.GET })
	...
	@Override
	@RequestMapping(produces = { MediaType.APPLICATION_JSON_VALUE }, consumes = {
			MediaType.APPLICATION_JSON_VALUE }, value = "/{username}", method = { RequestMethod.PUT })
	...
	@Override
	@RequestMapping(produces = { MediaType.APPLICATION_JSON_VALUE }, value = "/user", method = { RequestMethod.DELETE })
